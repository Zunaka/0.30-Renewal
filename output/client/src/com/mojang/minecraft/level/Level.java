      ...
      if(!Float.isNaN(var1.x) && !Float.isNaN(var1.y) && !Float.isNaN(var1.z)) {
         if(!Float.isNaN(var2.x) && !Float.isNaN(var2.y) && !Float.isNaN(var2.z)) {
            ...
            while(var9-- >= 0) {
               ...
               if(var21 > 0 && var23.getLiquidType() == LiquidType.NOT_LIQUID) {
                  MovingObjectPosition var22;
                  if(var23.isCube()) {
                     if((var22 = var23.clip(var6, var7, var8, var1, var2)) != null) {
                        return var22;
                     }
                  } else if((var22 = var23.clip(var6, var7, var8, var1, var2)) != null) {
                     return var22;
                  }
               }
            }
      ...
      for(int var12 = var6; var12 < var7; ++var12) {
         for(var13 = var9 - 1; var13 >= var8; --var13) {
            for(int var14 = var10; var14 < var11; ++var14) {
               ...
               int var20;
               if(var12 >= 0 && var13 >= 0 && var14 >= 0 && var12 < this.width && var13 < this.depth && var14 < this.height && var15 * var15 + var16 * var16 + var17 * var17 < var5 * var5 && (var20 = this.getTile(var12, var13, var14)) > 0 && Block.blocks[var20].canExplode()) {
                  Block.blocks[var20].dropItems(this, var12, var13, var14, 0.3F);
                  this.setTile(var12, var13, var14, 0);
                  Block.blocks[var20].explode(this, var12, var13, var14);
               }
            }
         }
      }
