   ...
   public final void render(float var1, boolean var2, int var3, int var4) {
      ...
      if(this.mc.gamemode.isSurvival()) {
         ...
         if(this.mc.player.isUnderWater()) {
            ...
            var25 = (int)Math.ceil((double)this.mc.player.airSupply * 10.0D / 300.0D) - var12;
      ...
      for(var12 = 0; var12 < var8.slots.length; ++var12) {
         var25 = this.width / 2 - 90 + var12 * 20;
         ...
         if((var15 = var8.slots[var12]) > 0) {
            ...
            if(var8.popTime[var12] > 0) {
               float var18;
               float var19 = -MathHelper.sin((var18 = ((float)var8.popTime[var12] - var1) / 5.0F) * var18 * 3.1415927F) * 8.0F;
               float var23 = MathHelper.sin(var18 * var18 * 3.1415927F) + 1.0F;
            ...
            if(var8.count[var12] > 1) {
               ...
               var5.render(var21, var25 + 19 - var5.getWidth(var21), var14 + 6, 16777215);
            }
         }
      }
      ...
      for(var14 = 0; var14 < this.chat.size() && var14 < var26; ++var14) {
