...
public final class AudioPacket {
   ...
   protected AudioPacket(VorbisStream var1, BitInputStream var2) {
      ...
      if(var2.getInt(1) != 0) {
         ...
         int[] var20 = this.mapping.getMagnitudes();
         ...
         if(!var19) {
            for(var11 = 0; var11 < var20.length; ++var11) {
               if(!this.noResidues[var20[var11]] || !this.noResidues[var21[var11]]) {
                  this.noResidues[var20[var11]] = false;
            ...
            for(var11 = this.mapping.getCouplingSteps() - 1; var11 >= 0; --var11) {
               float[] var16 = this.pcm[var20[var11]];
