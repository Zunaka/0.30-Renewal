...
public class Level implements Serializable {
   ...
   public boolean isSolidTile(int var1, int var2, int var3) {
      a var4;
      return (var4 = a.b[this.getTile(var1, var2, var3)]) == null?false:var4.c();
   }
      ...
      if(this.tickCount % 5 == 0) {
         ...
         for(var7 = 0; var7 < var6; ++var7) {
            ...
            if((var8 = (NextTickListEntry)this.tickList.remove(0)).ticks > 0) {
               ...
               byte var9;
               if(this.a(var8.x, var8.y, var8.z) && (var9 = this.blocks[(var8.y * this.height + var8.z) * this.width + var8.x]) == var8.blocks && var9 > 0) {
                  a.b[var9].a(this, var8.x, var8.y, var8.z, this.random);
               }
            }
         }
      }
      ...
      for(int var10 = var2; var10 < var3; ++var10) {
         for(var2 = var4; var2 < var5; ++var2) {
            for(int var8 = var6; var8 < var7; ++var8) {
               a var9;
               if((var9 = a.b[this.getTile(var10, var2, var8)]) != null && var9.d() != LiquidType.NOT_LIQUID) {
                  return true;
               }
            }
         }
      ...
      for(int var11 = var3; var11 < var4; ++var11) {
         for(var3 = var5; var3 < var6; ++var3) {
            for(int var9 = var7; var9 < var8; ++var9) {
               a var10;
               if((var10 = a.b[this.getTile(var11, var3, var9)]) != null && var10.d() == var2) {
                  return true;
               }
            }
         }
   ...
   private boolean a(float var1, float var2, float var3) {
      int var4;
      return (var4 = this.getTile((int)var1, (int)var2, (int)var3)) > 0 && a.b[var4].c();
   }

   public int getHighestTile(int var1, int var2) {
      int var3;
      for(var3 = this.depth; (this.getTile(var1, var3 - 1, var2) == 0 || a.b[this.getTile(var1, var3 - 1, var2)].d() != LiquidType.NOT_LIQUID) && var3 > 0; --var3) {
         ;
      }
   ...
   public LiquidType getLiquid(int var1, int var2, int var3) {
      int var4;
      return (var4 = this.getTile(var1, var2, var3)) == 0?LiquidType.NOT_LIQUID:a.b[var4].d();
   }

   public boolean isWater(int var1, int var2, int var3) {
      int var4;
      return (var4 = this.getTile(var1, var2, var3)) > 0 && a.b[var4].d() == LiquidType.WATER;
   }
   ...
   public Vector3DCreator clip(Vector3D var1, Vector3D var2) {
      if(!Float.isNaN(var1.x) && !Float.isNaN(var1.y) && !Float.isNaN(var1.z)) {
         if(!Float.isNaN(var2.x) && !Float.isNaN(var2.y) && !Float.isNaN(var2.z)) {
            ...
            while(var9-- >= 0) {
               ...
               Vector3D var20;
               var6 = (int)((var20 = new Vector3D(var1.x, var1.y, var1.z)).x = (float)Math.floor((double)var1.x));
               if(var24 == 5) {
                  --var6;
                  ++var20.x;
               }
               ...
               a var23 = a.b[var21];
               if(var21 > 0 && var23.d() == LiquidType.NOT_LIQUID) {
                  Vector3DCreator var22;
                  if(var23.a()) {
   ...
   public boolean maybeGrowTree(int var1, int var2, int var3) {
      ...
      if(!var5) {
         return false;
      } else if((this.blocks[((var2 - 1) * this.height + var3) * this.width + var1] & 255) == a.f.ab && var2 < this.depth - var4 - 1) {
         this.setTile(var1, var2 - 1, var3, a.g.ab);
            ...
            for(int var10 = var1 - var9; var10 <= var1 + var9; ++var10) {
               ...
               for(var6 = var3 - var9; var6 <= var3 + var9; ++var6) {
                  ...
                  if((Math.abs(var12) != var9 || Math.abs(var11) != var9 || this.random.nextInt(2) != 0 && var8 != 0) && this.getTile(var10, var13, var6) == 0) {
                     this.setTile(var10, var13, var6, a.v.ab);
                  }
               }
            }
         }
         ...
         for(var13 = 0; var13 < var4; ++var13) {
            if(this.getTile(var1, var2 + var13, var3) == 0) {
               this.setTile(var1, var2 + var13, var3, a.u.ab);
            }
         }
      ...
      for(int var12 = var6; var12 < var7; ++var12) {
         for(var13 = var9 - 1; var13 >= var8; --var13) {
            for(int var14 = var10; var14 < var11; ++var14) {
               ...
               int var20;
               if(var12 >= 0 && var13 >= 0 && var14 >= 0 && var12 < this.width && var13 < this.depth && var14 < this.height && var15 * var15 + var16 * var16 + var17 * var17 < var5 * var5 && (var20 = this.getTile(var12, var13, var14)) > 0 && a.b[var20].g()) {
                  a.b[var20].a(this, 0.3F);
