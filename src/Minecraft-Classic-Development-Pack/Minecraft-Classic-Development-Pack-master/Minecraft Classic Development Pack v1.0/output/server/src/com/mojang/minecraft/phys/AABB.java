...
public class AABB implements Serializable {
   ...
   public Vector3DCreator clip(Vector3D var1, Vector3D var2) {
      Vector3D var3 = var1.getXIntersection(var2, this.x0);
      Vector3D var4 = var1.getXIntersection(var2, this.x1);
      Vector3D var5 = var1.getYIntersection(var2, this.y0);
      Vector3D var6 = var1.getYIntersection(var2, this.y1);
      Vector3D var7 = var1.getZIntersection(var2, this.z0);
      ...
      if(var4 != null && (var8 == null || var1.distance(var4) < var1.distance(var8))) {
         var8 = var4;
      }

      if(var5 != null && (var8 == null || var1.distance(var5) < var1.distance(var8))) {
         var8 = var5;
      }

      if(var6 != null && (var8 == null || var1.distance(var6) < var1.distance(var8))) {
         var8 = var6;
      }

      if(var7 != null && (var8 == null || var1.distance(var7) < var1.distance(var8))) {
         var8 = var7;
      }

      if(var2 != null && (var8 == null || var1.distance(var2) < var1.distance(var8))) {
         var8 = var2;
      }
      ...
      if(var8 == null) {
         ...
         return new Vector3DCreator(0, 0, 0, var9, var8);
      }
   }
