...
public final class LevelGenerator {
   ...
   public final Level generate(String var1, int var2, int var3, int var4) {
      ...
      for(var51 = 0; var51 < var41.width; ++var51) {
         for(var53 = 0; var53 < var41.depth; ++var53) {
            double var20 = var6.compute((double)(var51 << 1), (double)(var53 << 1)) / 8.0D;
            var11 = var47.compute((double)(var51 << 1), (double)(var53 << 1)) > 0.0D?1:0;
            if(var20 > 2.0D) {
               var22 = ((var42[var51 + var53 * var41.width] - var11) / 2 << 1) + var11;
               var42[var51 + var53 * var41.width] = var22;
            }
         }
      }
      ...
      int var26;
      int var27;
      for(var23 = 0; var23 < var45; ++var23) {
         for(var10 = 0; var10 < var49; ++var10) {
            var11 = (int)(var54.compute((double)var23, (double)var10) / 24.0D) - 4;
            var24 = (var22 = var42[var23 + var10 * var45] + var41.waterLevel) + var11;
            var42[var23 + var10 * var45] = Math.max(var22, var24);
            if(var42[var23 + var10 * var45] > var51 - 2) {
               var42[var23 + var10 * var45] = var51 - 2;
            }

            if(var42[var23 + var10 * var45] < 1) {
               var42[var23 + var10 * var45] = 1;
            }
      ...
      var51 = this.depth;
      var53 = this.height;
      var23 = var49 * var51 * var53 / 256 / 64 << 1;

      for(var10 = 0; var10 < var23; ++var10) {
         float var55 = var41.random.nextFloat() * (float)var49;
         float var56 = var41.random.nextFloat() * (float)var53;
         float var58 = var41.random.nextFloat() * (float)var51;
         var25 = (int)((var41.random.nextFloat() + var41.random.nextFloat()) * 200.0F);
         float var61 = var41.random.nextFloat() * 3.1415927F * 2.0F;
         float var62 = 0.0F;
         ...
         for(var3 = 0; var3 < var25; ++var3) {
            var55 += MathHelper.sin(var61) * MathHelper.cos(var28);
            var58 += MathHelper.cos(var61) * MathHelper.cos(var28);
            var56 += MathHelper.sin(var28);
            var61 += var62 * 0.2F;
            var62 = (var62 *= 0.9F) + (var41.random.nextFloat() - var41.random.nextFloat());
            ...
            if(var41.random.nextFloat() >= 0.25F) {
               float var44 = var55 + (var41.random.nextFloat() * 4.0F - 2.0F) * 0.2F;
               float var48 = var56 + (var41.random.nextFloat() * 4.0F - 2.0F) * 0.2F;
               float var31 = var58 + (var41.random.nextFloat() * 4.0F - 2.0F) * 0.2F;
               float var32 = ((float)var41.height - var48) / (float)var41.height;
               var32 = 1.2F + (var32 * 3.5F + 1.0F) * var30;
               var32 = MathHelper.sin((float)var3 * 3.1415927F / (float)var25) * var32;

               for(int var33 = (int)(var44 - var32); var33 <= (int)(var44 + var32); ++var33) {
                  for(int var34 = (int)(var48 - var32); var34 <= (int)(var48 + var32); ++var34) {
                     for(int var35 = (int)(var31 - var32); var35 <= (int)(var31 + var32); ++var35) {
                        float var36 = (float)var33 - var44;
                        float var37 = (float)var34 - var48;
      ...
      for(var53 = 0; var53 < var41.width; ++var53) {
         var41.flood(var53, var41.height / 2 - 1, 0, 0, var51);
         var41.flood(var53, var41.height / 2 - 1, var41.depth - 1, 0, var51);
      }

      for(var53 = 0; var53 < var41.depth; ++var53) {
         var41.flood(0, var41.height / 2 - 1, var53, 0, var51);
         var41.flood(var41.width - 1, var41.height / 2 - 1, var53, 0, var51);
      }

      var53 = var41.width * var41.depth / 8000;

      for(var23 = 0; var23 < var53; ++var23) {
      ...
      for(var49 = 0; var49 < var45; ++var49) {
         ...
         var53 = (int)(var41.random.nextFloat() * var41.random.nextFloat() * (float)(var41.waterLevel - 3));
         var23 = var41.random.nextInt(var41.depth);
         if(var41.blocks[(var53 * var41.depth + var23) * var41.width + var51] == 0) {
            var41.flood(var51, var53, var23, 0, a.o.ab);
         }
      }
      ...
      for(var10 = 0; var10 < var45; ++var10) {
         for(var11 = 0; var11 < var49; ++var11) {
            boolean var57 = var54.compute((double)var10, (double)var11) > 8.0D;
            boolean var60 = var59.compute((double)var10, (double)var11) > 12.0D;
            var26 = ((var25 = var42[var10 + var11 * var45]) * var41.depth + var11) * var41.width + var10;
            if(((var27 = var41.blocks[((var25 + 1) * var41.depth + var11) * var41.width + var10] & 255) == a.l.ab || var27 == a.m.ab) && var25 <= var51 / 2 - 1 && var60) {
               var41.blocks[var26] = (byte)a.q.ab;
            }

            if(var27 == 0) {
               var63 = a.f.ab;
               if(var25 <= var51 / 2 - 1 && var57) {
                  var63 = a.p.ab;
               }

               var41.blocks[var26] = (byte)var63;
            }
         }
      }
      ...
      for(var51 = 0; var51 < var49; ++var51) {
         ...
         for(var11 = 0; var11 < 10; ++var11) {
            ...
            for(var25 = 0; var25 < 5; ++var25) {
               ...
               if((var53 < 2 || var41.random.nextInt(4) == 0) && var22 >= 0 && var24 >= 0 && var22 < var41.width && var24 < var41.depth) {
                  var26 = var42[var22 + var24 * var45] + 1;
                  if((var41.blocks[(var26 * var41.depth + var24) * var41.width + var22] & 255) == 0) {
                     var63 = (var26 * var41.depth + var24) * var41.width + var22;
                     if((var41.blocks[((var26 - 1) * var41.depth + var24) * var41.width + var22] & 255) == a.f.ab) {
                        if(var53 == 0) {
                           var41.blocks[var63] = (byte)a.O.ab;
                        } else if(var53 == 1) {
                           var41.blocks[var63] = (byte)a.P.ab;
                        }
                     }
                  }
               }
      ...
      for(var53 = 0; var53 < var51; ++var53) {
         ...
         for(var24 = 0; var24 < 20; ++var24) {
            ...
            for(var63 = 0; var63 < 5; ++var63) {
               ...
               if((var23 < 2 || var41.random.nextInt(4) == 0) && var25 >= 0 && var27 >= 0 && var26 >= 1 && var25 < var41.width && var27 < var41.depth && var26 < var42[var25 + var27 * var45] - 1 && (var41.blocks[(var26 * var41.depth + var27) * var41.width + var25] & 255) == 0) {
         ...
         for(var11 = 0; var11 < 20; ++var11) {
            ...
            for(var25 = 0; var25 < 20; ++var25) {
               ...
               if(var22 >= 0 && var24 >= 0 && var22 < var41.width && var24 < var41.depth) {
                  var26 = var52[var22 + var24 * var49] + 1;
               ...
               for(int var19 = (int)(var9 - var17); var19 <= (int)(var9 + var17); ++var19) {
                  for(int var20 = (int)(var10 - var17); var20 <= (int)(var10 + var17); ++var20) {
                     ...
                     if(var21 * var21 + var22 * var22 * 2.0F + var23 * var23 < var17 * var17 && var18 >= 1 && var19 >= 1 && var20 >= 1 && var18 < this.width - 1 && var19 < this.height - 1 && var20 < this.depth - 1) {
                        int var24 = (var19 * this.depth + var20) * this.width + var18;
                        if(this.blocks[var24] == a.e.ab) {
